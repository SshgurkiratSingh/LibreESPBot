...
void startCameraServer() {
    ...
    config.server_port = 81; // Standard port for MJPEG stream
...
void setup() {
    ...
    // Low latency optimization for PSRAM
    if (psramFound()) {
    ...
    // Vertical flip & Mirroring depending on physical mount orientation
...
void loop() {
    // Empty, everything runs asynchronously in the httpd server thread
    delay(10000);
}
